...
const CryptoCard = ({
  ...
  return (
    <div className="w-full overflow-x-auto">
      <div
        className="flex items-center w-[900px] py-4 px-6 bg-white rounded-lg shadow-sm hover:shadow-md hover:bg-amber-50/50 transition-all duration-300 group border-b border-gray-100"
        role="row"
      ...
      >
        ...
        <div className="flex items-center w-1/5 min-w-[200px] sm:min-w-[220px] space-x-4 sticky left-[60px] bg-white z-10">
          <img
            src={
              image ||
            ...
            onError={(e) => {
              ...
              e.target.src =
                "https://cryptocurrencyliveprices.com/img/coin.png";
            }}
          />
